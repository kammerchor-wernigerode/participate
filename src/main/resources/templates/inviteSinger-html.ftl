        ...
        <td class="container"
            ...
            <div class="content"
                ...
                <span class="preheader"
                      style="color: transparent; display: none; height: 0; max-height: 0; max-width: 0; opacity: 0; overflow: hidden; mso-hide: all; visibility: hidden; width: 0;">${event.name}</span>
                <table class="main"
                            ...
                            <table border="0" cellpadding="0" cellspacing="0"
                                ...
                                <tr>
                                    ...
                                    <#else>
                                        ...
                                        <p style="font-family: sans-serif; font-size: 14px; font-weight: normal; margin: 0; margin-bottom: 15px;">Even if you don't know exactly whether you can come, you may provisionally accept the invitation.</p>
