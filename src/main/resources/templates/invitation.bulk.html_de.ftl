                            ...
                            <table border="0" cellpadding="0" cellspacing="0"
                                ...
                                <tr>
                                    <td style="font-family: sans-serif; font-size: 14px; vertical-align: top;">
                                        <p style="color: #555; font-family: sans-serif; font-size: 14px; font-weight: normal; margin: 0; Margin-bottom: 15px;">${title}</p>
                                        <p style="font-family: sans-serif; font-size: 16px; font-weight: bold; margin: 0; Margin-bottom: 15px;">
                                            Hallo <span style="color: #3498db;">${singer.firstName}</span>,
                                        </p>
                                        ...
                                        <table border="0" cellpadding="0" cellspacing="0"
                                               style="border-collapse: separate; mso-table-lspace: 0pt; mso-table-rspace: 0pt; width: 100%; margin-bottom: 15px;">
                                            <tbody>
                                            <#list items as item>
                                                ...
                                                <tr>
                                                    ...
                                                    <td style="padding: 2px;">
                                                        <span style="font-family: sans-serif; font-size: 14px; font-weight: normal; margin: 0;"><#if event.location??>${event.location}<#else>N/A</#if></span>
                                                    </td>
                                                    <td style="padding: 2px;">
                                        ...
                                        <p style="font-family: sans-serif; font-size: 14px; font-weight: normal; margin: 0; Margin-bottom: 15px;">
                                            Die Termine findest du außerdem in unserem <a href="${calendarUrl.apply(items[0].event, .locale_object)}">Kalender</a>.
                                        </p>
                                    </td>
                                </tr>
                            </table>
