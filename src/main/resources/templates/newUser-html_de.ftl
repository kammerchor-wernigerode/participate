        ...
        <td class="container"
            ...
            <div class="content"
                ...
                <span class="preheader"
                      style="color: transparent; display: none; height: 0; max-height: 0; max-width: 0; opacity: 0; overflow: hidden; mso-hide: all; visibility: hidden; width: 0;">Ein neues Benutzerkonto wurde angelegt</span>
                <table class="main"
                                ...
                                <tr>
                                    <td style="font-family: sans-serif; font-size: 14px; vertical-align: top;">
                                        ...
                                        <p style="font-family: sans-serif; font-size: 14px; font-weight: normal; margin: 0; Margin-bottom: 15px;">
                                            wir haben ein neues Konto f&uuml;r dich angelegt.
                                        </p>
                                        <p style="font-family: sans-serif; font-size: 14px; font-weight: normal; margin: 0; Margin-bottom: 15px;">
                                            Klick auf den Button, um dein Passwort festzulegen und die Registrierung
                                        ...
                                        <p style="font-family: sans-serif; font-size: 14px; font-weight: normal; margin: 0; Margin-bottom: 15px;">
                                            Du kannst danach dein Passwort auch jederzeit in deinen Kontoeinstellungen
                                            ändern.</p>
                                    </td>
                                </tr>
                            </table>
