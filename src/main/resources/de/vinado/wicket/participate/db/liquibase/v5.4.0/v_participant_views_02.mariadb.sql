...
FROM participants participant
         INNER JOIN singers singer ON participant.singer_id = singer.person_id
...
SELECT participant.event_id                          AS event_id,
       ...
       GROUP_CONCAT(person.first_name,
                    ' ',
                    person.last_name SEPARATOR ', ') AS declined_name
FROM participants participant
         INNER JOIN singers singer ON participant.singer_id = singer.person_id
         INNER JOIN persons person ON singer.person_id = person.id
...
SELECT participant.event_id                          AS event_id,
       ...
       GROUP_CONCAT(person.first_name,
                    ' ',
                    person.last_name SEPARATOR ', ') AS tentative_name
FROM participants participant
         INNER JOIN singers singer ON participant.singer_id = singer.person_id
         INNER JOIN persons person ON singer.person_id = person.id
...
SELECT participant.event_id                          AS event_id,
       ...
       GROUP_CONCAT(person.first_name,
                    ' ',
                    person.last_name SEPARATOR ', ') AS soprano_name
FROM participants participant
         INNER JOIN singers singer ON participant.singer_id = singer.person_id
         INNER JOIN persons person ON singer.person_id = person.id
...
SELECT participant.event_id                          AS event_id,
       ...
       GROUP_CONCAT(person.first_name,
                    ' ',
                    person.last_name SEPARATOR ', ') AS alto_name
FROM participants participant
         INNER JOIN singers singer ON participant.singer_id = singer.person_id
         INNER JOIN persons person ON singer.person_id = person.id
...
SELECT participant.event_id                          AS event_id,
       ...
       GROUP_CONCAT(person.first_name,
                    ' ',
                    person.last_name SEPARATOR ', ') AS tenor_name
FROM participants participant
         INNER JOIN singers singer ON participant.singer_id = singer.person_id
         INNER JOIN persons person ON singer.person_id = person.id
...
SELECT participant.event_id                          AS event_id,
       ...
       GROUP_CONCAT(person.first_name,
                    ' ',
                    person.last_name SEPARATOR ', ') AS bass_name
FROM participants participant
         INNER JOIN singers singer ON participant.singer_id = singer.person_id
         INNER JOIN persons person ON singer.person_id = person.id
