CREATE OR REPLACE VIEW v_event_details AS
  SELECT
    ...
    ev.cast                              AS cast,
    SUM(CASE WHEN ev_member.needs_dinner THEN 1 ELSE 0 END)         AS count_dinner,
    SUM(CASE WHEN ev_member.needs_place_to_sleep THEN 1 ELSE 0 END) AS count_place_to_sleep,
