...
import de.vinado.wicket.participate.component.behavoir.decorator.BootstrapInlineFormDecorator;
...
public abstract class BootstrapModalPanel<T> extends Panel {
     ...
     * {@link #setModalSize(de.vinado.wicket.participate.component.modal.BootstrapModalPanel.ModalSize, org.apache.wicket.ajax.AjaxRequestTarget)}
     */
