...
public class EventDetailsView implements Identifiable, Serializable {
    ...
    public boolean equals(final Object o) {
        ...
        if (!(o instanceof EventDetailsView)) return false;

        final EventDetailsView that = (EventDetailsView) o;
